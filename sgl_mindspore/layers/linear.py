...
class MergedColParallelLinear(ColParallelLinear):
    ...
    def weight_load(self, param: Parameter, weight: torch.Tensor, shard_id=None) -> None:
        ...
        for size in self.output_sizes:
            ...
            w_shard = weight.narrow(0, weight_offset + tp_rank * shard_size, shard_size).contiguous()
            param[param_offset : param_offset + shard_size, :] = tensor_torch2ms(w_shard)
            weight_offset += size
